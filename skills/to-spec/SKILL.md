...
Also draw on this conversation. **Standalone fallback:** if no run dir matches, synthesize from the conversation alone — don't require a grill — and still produce the governing invariants block.
